...
from app.tests.utils.quest import create_random_quest, QuestApplicationFactory
from app.tests.utils.user import create_random_user


def test_apply_to_quest(
    client: TestClient, normal_user_token_headers: dict[str, str], db: Session, quest_application_data: dict
) -> None:
...
def test_apply_to_quest_not_found(
    client: TestClient, normal_user_token_headers: dict[str, str], quest_application_data: dict
) -> None:
    quest_id = uuid.uuid4()
    # application_data provided by fixture
    response = client.post(
