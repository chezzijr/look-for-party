...
export type QuestCategory = 'GAMING' | 'PROFESSIONAL' | 'SOCIAL' | 'LEARNING' | 'CREATIVE' | 'FITNESS' | 'TRAVEL';
...
export type QuestStatus = 'RECRUITING' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED' | 'EXPIRED';
...
export type QuestType = 'INDIVIDUAL' | 'PARTY_INTERNAL' | 'PARTY_EXPANSION' | 'PARTY_HYBRID';
...
export type TagCategory = 'PROGRAMMING' | 'FRAMEWORK' | 'TOOL' | 'GAME' | 'GAME_GENRE' | 'ART' | 'MUSIC' | 'MEDIA' | 'SPORT' | 'FITNESS' | 'LANGUAGE' | 'SUBJECT' | 'SKILL' | 'HOBBY' | 'LOCATION' | 'STYLE';
...
export type QuestApplicationsReadMyApplicationsResponse = (QuestApplicationsPublic);
...
export type QuestApplicationsReadQuestApplicationsResponse = (QuestApplicationsPublic);
